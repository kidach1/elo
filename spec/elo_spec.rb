...
require File.expand_path(File.dirname(__FILE__) + '../../lib/elo.rb')
...
=end
  describe 'wikipedia-way' do
    let(:players) do [
      Elo::Player.new(1613, 4),
      Elo::Player.new(1609, 2),
      Elo::Player.new(1477, 4),
      Elo::Player.new(1388, 6),
      Elo::Player.new(1586, 6),
      Elo::Player.new(1720, 2) ]
    end

    it do
      game = Elo::Game.new(players)
